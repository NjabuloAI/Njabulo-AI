  ...
  run: async (context) => {
    ...
    try {
      ...
      if (
        ...
        return m.reply(`Who the fuck am I torching? Tag someone or I’ll roast your sorry ass to ashes!`);
      }
      ...
      if (!targetNumber) {
        ...
        return m.reply(`This user’s ID is fucked beyond repair. Try again, you brainless twit!`);
      }
      ...
      const checkingMsg = await client.sendMessage(
        m.chat,
        {
          text: `Cracking open @${targetNumber}'s soul for gay vibes... 🩸\nThis is gonna hurt like hell, you weakling!`,
          mentions: [targetUser],
        },
        { quoted: m }
      );
...
`;
      ...
      await m.reply(`This shit blew up harder than your ego! Can’t check gay levels now, you doomed idiot!`);
    }
  },
};