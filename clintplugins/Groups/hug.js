module.exports = {
  ...
  description: 'Hugs a tagged or quoted user with a ➥ sir Njabulo AIメ, realistic reaction',
  run: async (context) => {
    ...
    try {
      ...
      if (!m.mentionedJid || m.mentionedJid.length === 0) {
        if (!m.quoted || !m.quoted.sender) {
          ...
          return m.reply(`Yo, softie, tag someone or quote a message to hug! I ain’t hugging nobody without a target!`);
        }
      }
      ...
      const huggingMsg = await client.sendMessage(
        m.chat,
        {
          text: `@${senderNumber} is wrapping their arms around @${targetNumber}... 🤗\nThis might get awkward, bitch!`,
...
`;
      ...
      await m.reply(`Shit broke harder than your heart! Can’t hug right now, you pathetic fuck.`);
    }
  },
};