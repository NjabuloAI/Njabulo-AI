    ...
    try {
      ...
      if (!m.mentionedJid || m.mentionedJid.length === 0) {
        if (!m.quoted || !m.quoted.sender) {
          ...
          return m.reply(`Yo, moron, tag someone or quote a message to kiss! I ain’t kissing nobody without a target!`);
        }
      }
      ...
      if (
        ...
        return m.reply(`Invalid user, dumbass! Tag or quote a real person to kiss!`);
      }
      ...
      const kissingMsg = await client.sendMessage(
        m.chat,
        {
          text: `@${senderNumber} is puckering up to kiss @${targetNumber}... 💋\n Hope you’re ready for this, loser!`,
...
`;
      ...
      await m.reply(`Shit broke harder than your love life! Can’t kiss right now, you pathetic fuck.`);
    }
  },
};