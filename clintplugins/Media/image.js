  ...
  try {
    ...
    for (const imgUrl of imagesToSend) {
      try {
       ...
       const buttons = [
      {
        "buttonId":  `${prefix}gpt ${text}`,
        "buttonText": { "displayText": "🥀Cut image" },
        "type": 1
      },
      {
        "buttonId":  `${prefix}ai ${text}`,
        "buttonText": { "displayText": "🌹Beautiful" },
        "type": 1
      },
      {
        "buttonId":  `${prefix}imagine ${text}`,
        "buttonText": { "displayText": "🖼️General" },
        "type": 1
      },
      {
        "buttonId":  `${prefix}aisearch ${text}`,
        "buttonText": { "displayText": "🌠AI image" },
        "type": 1
      }
    ];
