...
module.exports = async (context) => {
    ...
    await ownerMiddleware(context, async () => {
        ...
        try {
            await m.reply("💣 *➥ sir Njabulo AIメ Update Unleashed!* Scanning GitHub for fresh chaos... 😈");
            ...
            const repoUrl = "https://api.github.com/repos/NjabuloAI/Njabulo-AI/commits/main";
            const { data: commitData } = await axios.get(repoUrl, {
                headers: { "User-Agent": "Njabulo-AI-Bot" }
            }).catch(err => {
            ...
            if (latestSha === currentSha) {
                return await m.reply("🛡️ *No updates, loser!* ➥ sir Njabulo AIメ is already peak chaos. 🔥");
            }
            ...
            const { data: zipData } = await axios.get("https://github.com/NjabuloA(/Njabulo-AI/archive/main.zip", {
            ...
            const sourcePath = path.join(extractPath, "Njabulo-AI");
            ...
            await m.reply(
                "😈 *➥ sir Njabulo AIメ updated! Dyno restarting in 3 seconds...* ⚠️ *Warning*: Heroku updates are temporary unless you push to git. Check logs for manual steps! 🔥"
            );
